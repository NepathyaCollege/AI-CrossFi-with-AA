  ...
  return (
    <IonContent className="ion-padding">
      <IonGrid className=" h-4/5 w-full   ">
        <IonRow className="ion-justify-content-center pt-[70%]     ion-align-items-center   gap-4 ">
          <IonCol size="12">
            <IonImg
              src="ChatBot.png"
              className=" h-20  w-20 rounded-full overflow-hidden mx-auto"
            />
          </IonCol>
          <IonCol size="auto">
      ...
      <IonGrid className="w-full  mt-20 justify-end  ">
